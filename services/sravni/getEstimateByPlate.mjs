...
const getEstimateByPlate = async plate => {
    ...
    const cookies = [
        ...
        {name: 'prc_osago', value: 'us=eaisto.me_3718&um=cpa&uc=osago_link&p_offer_id=1064&aff_id=1425&source=3718&tid=1022c4bf5f4fe2733137b2444939e9&targeted=True', domain: '.sravni.ru'},
        ...
        {name: '__utmz', value: 'utmccn=(not set)|utmcct=(not set)|utmcmd=referral|utmcsr=eaisto.me|utmctr=(not set)', domain: '.sravni.ru'},
        {name: '_ipl', value: '6.83.', domain: '.sravni.ru'},
        {name: '_cfuvid', value: 'WOolfGxNAZJrKCJu4Q_n9t4chTnACB1UFZsbGwqrj_g-1675179275084-0-604800000', domain: '.sravni.ru'},
        {name: '_ym_isad', value: '2', domain: '.sravni.ru'},
        {name: '_gid', value: 'GA1.2.1002347441.1675179277', domain: '.sravni.ru'},
        {name: '__utmx', value: 'utmccn=(not set)|utmcct=(not set)|utmcmd=(none)|utmcsr=(direct)|utmctr=(not set)', domain: '.sravni.ru'},
        {name: '__cf_bm', value: 'Wra5AbhJa533J0EKVk8EozGfcLxa1LXZSKbs.Ip3dqE-1675184873-0-AfLV8MeZqv0R/aDe02vjo2Xzw553LibaVqCUUTsL2CnQHKAG+21TRPtcUSVgCSiiMjpQbomahptNmyr+wCxmSMgpvhGELYA8wxInQgCZFpkl5HqaM3BLTbwPnXT2+bNnidSxDBT1paAdjGTxntED0tqev/4DnFdCcNpkr4aMg1PhWY7T7GpemQe1MhnkpI9Di1Pv0UH0bq2mqt5Ou/XbOs4=', domain: '.sravni.ru'},
